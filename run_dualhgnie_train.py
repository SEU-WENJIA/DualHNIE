...
from model.DualHGNIE import DualHGNIE 
from utils.EarlyStopping import EarlyStopping_simple
from utils.utils import get_rank_metrics, rank_evaluate, get_hypergraph_centrality,set_random_seed
...
def main(args,logger):
    ...
    # set the save path
    save_root = 'results/' + args.dataset + '_DualHGNIE/'
